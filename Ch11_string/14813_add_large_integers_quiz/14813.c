/*
 * NTHU EE2310 - 題目 14813: Add Large Integers (Quiz)
 *
 * 【課本參考】《由片語學習C程式設計（第二版）》
 *   第 11 章（字串）
 *   如果不知道如何解題，請參考課本第 11 章的說明。
 *
 * 【題目連結】https://acm.cs.nthu.edu.tw/problem/14813/
 *
 * 【題目說明】
 * 將兩個正整數相加，每個數最多 18 位數（小考版）。
 * 以字串方式讀入，用字串加法手動計算，輸出其和。
 * 範例：123456789012345678 + 987654321098765432 = 1111111110111111110
 *
 * 【解題策略】
